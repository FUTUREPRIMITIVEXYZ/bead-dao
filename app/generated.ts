// Generated by @wagmi/cli@1.3.0 on 8/3/2023 at 6:12:56 PM
import {
  useContractRead,
...
/**
 * [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0xa17f131B2d6C3AFa64f24dA5e1ce98cffaabDf7D)
 */
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link beadABI}__ and `functionName` set to `"beadHash"`.
 *
 * [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0xa17f131B2d6C3AFa64f24dA5e1ce98cffaabDf7D)
 */
export function useBeadBeadHash<
  TFunctionName extends 'beadHash',
  TSelectData = ReadContractResult<typeof beadABI, TFunctionName>
>(
  config: Omit<
    UseContractReadConfig<typeof beadABI, TFunctionName, TSelectData>,
  ...
  return useContractRead({
    abi: beadABI,
    address: beadAddress[11155111],
    functionName: 'beadHash',
    ...config,
  } as UseContractReadConfig<typeof beadABI, TFunctionName, TSelectData>)
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link beadABI}__ and `functionName` set to `"beadId"`.
 *
 * [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0xa17f131B2d6C3AFa64f24dA5e1ce98cffaabDf7D)
 */
export function useBeadBeadId<
  TFunctionName extends 'beadId',
  TSelectData = ReadContractResult<typeof beadABI, TFunctionName>
>(
  config: Omit<
    UseContractReadConfig<typeof beadABI, TFunctionName, TSelectData>,
